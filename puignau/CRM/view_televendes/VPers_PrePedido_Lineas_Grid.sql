...
--OUTER APPLY fPers_DamePrecio_Articulo_Delegacion_v2(v.IdArticulo, pp.IdCliente, cde.idlista, pp.Fecha_Pedido, null,null,(select top 1 iddelegacion from delegaciones where idempresa = pp.IdEmpresa)) as precioAct