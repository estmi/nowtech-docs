SELECT  "Albaranes_Cli_Cab"."IdAlbaran"
       ...
       ,"Clientes_Datos"."Nif"
FROM
(((((((((((((("PuignauERP"."dbo"."Albaranes_Cli_Cab" "Albaranes_Cli_Cab"
	LEFT OUTER JOIN "PuignauERP"."dbo"."Clientes_Datos" "Clientes_Datos"
	ON "Albaranes_Cli_Cab"."IdCliente" = "Clientes_Datos"."IdCliente")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Series_Facturacion" "Series_Facturacion"
	ON "Albaranes_Cli_Cab"."SerieAlbaran" = "Series_Facturacion"."SerieFactura")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Pers_albaranes_lineas_min4" "Pers_albaranes_lineas_min"
	ON "Albaranes_Cli_Cab"."IdAlbaran" = "Pers_albaranes_lineas_min"."idalbaran")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Pedidos_Cli_Lineas" "Pedidos_Cli_Lineas"
	ON ("Albaranes_Cli_Cab"."IdAlbaran" = "Pedidos_Cli_Lineas"."IdAlbaran") AND ("Pers_albaranes_lineas_min"."iddoc" = "Pedidos_Cli_Lineas"."IdDoc"))
	LEFT OUTER JOIN "PuignauERP"."dbo"."vPers_CR_Albaranes_Facturas" "vPers_CR_Albaranes_Facturas"
	ON "Albaranes_Cli_Cab"."IdAlbaran" = "vPers_CR_Albaranes_Facturas"."IdAlbaran")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Clientes_Datos_Comerciales" "Clientes_Datos_Comerciales"
	ON "Clientes_Datos"."IdCliente" = "Clientes_Datos_Comerciales"."IdCliente")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Conf_Clientes" "Conf_Clientes"
	ON "Clientes_Datos"."IdCliente" = "Conf_Clientes"."IdCliente")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Clientes_Datos_Economicos" "Clientes_Datos_Economicos"
	ON "Clientes_Datos"."IdCliente" = "Clientes_Datos_Economicos"."IdCliente")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Zonas" "Zonas"
	ON "Clientes_Datos_Comerciales"."Zona" = "Zonas"."Zona")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Rutas" "Rutas"
	ON "Clientes_Datos_Comerciales"."IdRuta" = "Rutas"."IdRuta")
	LEFT OUTER JOIN "PuignauERP"."dbo"."ClientesFact_Tipos" "ClientesFact_Tipos"
	ON "Clientes_Datos_Economicos"."TipoFacturacion" = "ClientesFact_Tipos"."IdTipo")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Articulos" "Articulos"
	ON "Pedidos_Cli_Lineas"."IdArticulo" = "Articulos"."IdArticulo")
	LEFT OUTER JOIN "PuignauERP"."dbo"."IVAs" "IVAs"
	ON "Pedidos_Cli_Lineas"."IdIva" = "IVAs"."IdIVA")
	LEFT OUTER JOIN "PuignauERP"."dbo"."Pedidos_Cli_Cabecera" "Pedidos_Cli_Cabecera"
	ON "Pedidos_Cli_Lineas"."IdPedido" = "Pedidos_Cli_Cabecera"."IdPedido"
)
LEFT OUTER JOIN "PuignauERP"."dbo"."Empleados_Datos" "Representantes"
